    ...
    <div class="screen" style="background: #868b90;">
      ...
      <div class="screen-body">
        <div class="screen-body-item left">
          <img class="img-fluid" src="images/bb.jpg" style="border: none; border-radius: 10%;">
        </div>
        <div class="screen-body-item">
          <form class="app-form" method="post">
            ...
            <div class="app-form-group">
              <input class="app-form-control" style="text-align:center;" placeholder="INITIAL BALANCE" type="number" name="balance" required>
            </div>
            <br>
            <div class="app-form-group button">
              ...
              <input class="app-form-button" style="color:black; background-color: white; border-radius:0.5rem;" type="reset" value="RESET" name="reset"></input>
            </div>
          </form>
        </div>
      </div>
...
<footer class="text-center mt-5 py-2" style="background-color : orange;">
            <p>&copy 2021 Made by <b>MD MUSABBIR AFQUE For #gripnov21</b></p>
</footer>
